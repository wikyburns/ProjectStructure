...
enum SlamOption
{
    ObjectScanning = 0,
    STSlamManager,
    Default = ObjectScanning,
};

// SLAM-related members.
struct SlamData
{
    SlamData() : initialized(false), scannerState(ScannerStateCubePlacement)
    {}
    ...
    SlamOption slamOption = SlamOption::Default;
    STScene* scene;
    STSLAMManager* lssTracker;
    STTracker* tracker;
    STMapper* mapper;
...
{
    PinchScaleState() : currentScale(1.f), initialPinchScale(1.f)
    {}
...
struct AppStatus
{
    ...
    NSString* const needColorCameraAccessMessage =
        @"This app requires camera access to capture rooms.\nAllow access by going to Settings → Privacy → Camera.";
        ...
        SettingsPopupViewDelegate>
{
    ...
    NSString* _timeTagOnOcc;

    bool _enableDepthWindowOverride;
    bool _runDepthRefinement;
    float _depthWindowSearchWidth;
    float _depthWindowSearchHeight;

    bool _alignCubeWithCamera;
    bool _fixedCubePosition;
    float _initialBoxDistance;
}

@property(weak, nonatomic) IBOutlet UILabel* alignCubeWithCameraLabel;
@property(weak, nonatomic) IBOutlet UILabel* fixedCubeDistanceLabel;
@property(weak, nonatomic) IBOutlet UILabel* boxDistanceLabel;
@property(weak, nonatomic) IBOutlet UILabel* boxSizeLabel;
@property(weak, nonatomic) IBOutlet UISwitch* alignCubeWithCameraSwitch;
@property(weak, nonatomic) IBOutlet UISwitch* fixedCubeDistanceSwitch;
@property(weak, nonatomic) IBOutlet UISlider* cubeDistanceSlider;
...
@property (weak, nonatomic) IBOutlet UIButton *poweredByStructureButton;
@property (weak, nonatomic) IBOutlet UIView *batteryView;
@property(weak, nonatomic) IBOutlet UIImageView* batteryImageView;
@property (weak, nonatomic) IBOutlet UILabel *batterySensorLabel;
