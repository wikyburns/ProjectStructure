    ...
    switch (_overlayType)
    {
        case CalibrationOverlayTypeNone:
        {
            ...
            UIImageView* imageView =
                [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"image-wvl-calibration.png"]];
            ...
            [attrSub addAttribute:NSParagraphStyleAttributeName value:subStyle range:NSMakeRange(0, [subText length])];
            ...
            [messageLabel addConstraints:@[ // Set message height to 26.0
                [NSLayoutConstraint constraintWithItem:messageLabel attribute:NSLayoutAttributeHeight
                                             relatedBy:NSLayoutRelationEqual
                                                toItem:nil
                                             attribute:NSLayoutAttributeNotAnAttribute
                                            multiplier:1.0
            ...
            [calibrateButton setTitleColor:[[UIColor whiteColor] colorWithAlphaComponent:0.76]
                                  forState:UIControlStateHighlighted];

            [calibrateButton
                setBackgroundImage:imageWithColor([UIColor whiteColor], CGRectMake(0.0, 0.0, 260.0, 50.0), 25.0)
                          forState:UIControlStateNormal];
            [calibrateButton
                setBackgroundImage:imageWithColor([UIColor lightGrayColor], CGRectMake(0.0, 0.0, 260.0, 50.0), 25.0)
                          forState:UIControlStateHighlighted];
            ...
            [calibrateButton addTarget:self action:@selector(calibrationButtonClicked:)
        ...
        case CalibrationOverlayTypeApproximate:
        {
            ...
            [message addConstraint:[NSLayoutConstraint constraintWithItem:message attribute:NSLayoutAttributeHeight
                                                                relatedBy:NSLayoutRelationEqual
                                                                   toItem:nil
                                                                attribute:NSLayoutAttributeNotAnAttribute
                                                               multiplier:1.0
            ...
            [calibrationButton addTarget:self action:@selector(calibrationButtonClicked:)
                        forControlEvents:UIControlEventTouchUpInside];
        ...
        case CalibrationOverlayTypeStrictlyRequired:
        {
            ...
            [wvl.superview addConstraints:@[
                [NSLayoutConstraint constraintWithItem:wvl attribute:NSLayoutAttributeTop
                                             relatedBy:NSLayoutRelationEqual
                                                toItem:wvl.superview
                                             attribute:NSLayoutAttributeTop
                                            multiplier:1.0
                                              constant:0.0],
                [NSLayoutConstraint constraintWithItem:wvl attribute:NSLayoutAttributeLeft
                                             relatedBy:NSLayoutRelationEqual
                                                toItem:wvl.superview
                                             attribute:NSLayoutAttributeLeft
                                            multiplier:1.0
                                              constant:5.0],
                [NSLayoutConstraint constraintWithItem:wvl attribute:NSLayoutAttributeBottom
                                             relatedBy:NSLayoutRelationEqual
                                                toItem:wvl.superview
                                             attribute:NSLayoutAttributeBottom
                                            multiplier:1.0
                                              constant:0.0],
                [NSLayoutConstraint constraintWithItem:wvl attribute:NSLayoutAttributeRight
                                             relatedBy:NSLayoutRelationEqual
                                                toItem:wvl.superview
                                             attribute:NSLayoutAttributeRight
                                            multiplier:1.0
            ...
            [calibrateButton
                setBackgroundImage:imageWithColor([UIColor whiteColor], CGRectMake(0.0, 0.0, 413.0, 50.0), 25.0)
                          forState:UIControlStateNormal];
            [calibrateButton
                setBackgroundImage:imageWithColor([UIColor lightGrayColor], CGRectMake(0.0, 0.0, 413.0, 50.0), 25.0)
                          forState:UIControlStateHighlighted];
