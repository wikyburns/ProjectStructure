...
// Helper functions.
GLuint loadOpenGLProgramFromString(
...
public:
    ...
    virtual void load()
    {
        ...
        _glProgram = loadOpenGLProgramFromString(
            vertexShaderSource(),
...
public:
    virtual void load()
    {
        ...
        _glProgram =
            loadOpenGLProgramFromString(vertexShaderSource(), fragmentShaderSource(), 2, attributeIds, attributeNames);
